...
* `key` - {{% badge %}}Both{{% /badge %}} autogenerated internal key used to identify the LTI Consumer
  * This key is used in lieu of the database ID to prevent guessing attacks against sequential values. The key is generated using [nanoid](https://github.com/ai/nanoid)
...
* `key` - {{% badge %}}Auto{{% /badge %}} autogenerated internal key used to identify the LTI Consumer
* `state` - {{% badge %}}Auto{{% /badge %}} autogenerated internal state shared with the LTI Consumer. Generated using [nanoid](https://github.com/ai/nanoid)
* `nonce` - {{% badge %}}Auto{{% /badge %}} autogenerated internal nonce shared with the LTI Consumer. Generated using [nanoid](https://github.com/ai/nanoid)
...
* `key` - {{% badge %}}Both{{% /badge %}} autogenerated internal key used to identify the LTI Tool Provider
  * This key is used in lieu of the database ID to prevent guessing attacks against sequential values. The key is generated using [nanoid](https://github.com/ai/nanoid)
...
* `key` - {{% badge %}}Auto{{% /badge %}} autogenerated internal key used to identify the LTI Tool Provider
