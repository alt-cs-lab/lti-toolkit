/**
 * @file LTI Instructor Create Line Item Example
 * @author Russell Feldhausen <russfeld@ksu.edu>
 * @exports InstructorCreateLineItemHandler LTI Instructor Create Line Item Handler
 */
...
async function InstructorCreateLineItemHandler(req, res) {
  ...
  // Re-fetch AGS data so the page renders with the newly-created line item
...
export default InstructorCreateLineItemHandler;
