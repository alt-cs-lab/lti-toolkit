...
import InstructorCreateLineItemHandler from "./routes/instructor-create-lineitem.js";
import InstructorUpdateLineItemHandler from "./routes/instructor-update-lineitem.js";
import InstructorLineItemGradeHandler from "./routes/instructor-lineitem-grade.js";
...
app.post("/instructor/lineitem/create", requireLTI, InstructorCreateLineItemHandler);
app.post("/instructor/lineitem/update", requireLTI, InstructorUpdateLineItemHandler);
app.post("/instructor/lineitem/grade", requireLTI, InstructorLineItemGradeHandler);
